'use strict';
  ...
  ThreejsScene.prototype.initRenderer = function () {
    ...
    self.renderer.setClearColor(0x1E1E20, 1.0);
  ...
  ThreejsScene.prototype.shiftRGB = function () {
    ...
    self.tl = new TimelineMax({repeat: 0, repeatDelay: 0.00001, delay: 0.5});
    self.tl.to(rgbShift.uniforms.angle, 2, {value: 0.5, ease: Power1.easeInOut});
    self.tl.to(rgbShift.uniforms.amount, 2, {value: 0.004, ease: Power1.easeInOut}, "=-2");
  };
  ...
  ThreejsScene.prototype.initObjects = function () {
    ...
    material = new THREE.MeshLambertMaterial({
      map: THREE.ImageUtils.loadTexture('../newsletter-top.png'),
      transparent: true,
      opacity: 0.7
    });
  ...
  ThreejsScene.prototype.addLogo = function () {
    ...
    var material = new THREE.MeshBasicMaterial({
      map: THREE.ImageUtils.loadTexture('../newsletter-top.png'), transparent: true, opacity: 0.9
    });
  ...
  ThreejsScene.prototype.addSmoke = function () {
    ...
    var geometry = new THREE.PlaneGeometry(27, 27);
    var material = new THREE.MeshBasicMaterial({
      map: THREE.ImageUtils.loadTexture('../newsletter-top.png'),
      transparent: true,
      opacity: 0.6
    ...
    self.tl.to(plane.material, 1.2, {opacity: 0, ease: Power1.easeOut}, "=-1");
